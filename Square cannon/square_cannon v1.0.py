...
def aiming():
    ...
    parabolicMovement(turretChosen[0], turretChosen[1], cannonVelocity, cannonAngle, True, 20)
...
def firing():
    ...
    for i in range(1, 250):
        cannonBall.x0 = parabolicMovement(turretChosen[0], turretChosen[1], cannonVelocity, cannonAngle, False, i)[0]
